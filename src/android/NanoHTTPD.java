...
{
	private final String LOGTAG = "Autoserver";
...
*/
			...
			boolean allowDirectoryListing )
	{
		...
		if ( !homeDir.isDirectory()) {
			...
			Log.e(LOGTAG, "INTERNAL ERRROR: serveFile(): given homeDir is not a directory.");
		}
		...
		if ( res == null )
		{
			...
			if ( uri.startsWith( ".." ) || uri.endsWith( ".." ) || uri.indexOf( "../" ) >= 0 ) {
				...
				Log.e(LOGTAG, "FORBIDDEN: Won't serve ../ for security reasons.");
			}
		}
		...
		if ( res == null && !f.exists()) {
			...
			Log.e(LOGTAG, "Error 404, file not found.");
			}
		...
		if ( res == null && f.isDirectory())
		{
			...
			if ( res == null )
			{
				...
				else
				{
					...
					Log.e(LOGTAG, "FORBIDDEN: No directory listing.");
				}
			}
		}
		...
		catch( IOException ioe )
		{
			...
			Log.e(LOGTAG, "FORBIDDEN: Reading file failed.");
		}
